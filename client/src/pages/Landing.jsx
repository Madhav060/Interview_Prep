      ...
      <div className="min-h-screen bg-white">
        ...
        <div className="relative overflow-hidden">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link
                  to="/signup"
                  className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-lg font-semibold rounded-xl hover:shadow-2xl transition transform hover:scale-105"
                >
                ...
                <a
                  href="#features"
                  className="inline-flex items-center justify-center px-8 py-4 border-2 border-gray-300 text-gray-700 text-lg font-semibold rounded-xl hover:border-indigo-600 hover:text-indigo-600 transition"
                >
                  Learn More
                </a>
              </div>
          ...
          <div className="absolute top-0 left-0 w-full h-full -z-10 overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-96 h-96 bg-indigo-300 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-blob animation-delay-2000"></div>
          </div>
        </div>
        ...
        <div id="features" className="py-20 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600">Three simple steps to interview mastery</p>
            </div>
        ...
        <div className="py-20 bg-gradient-to-r from-indigo-600 to-purple-600">
          <div className="max-w-4xl mx-auto text-center px-4">
            ...
            <Link
              to="/signup"
              className="inline-flex items-center px-8 py-4 bg-white text-indigo-600 text-lg font-semibold rounded-xl hover:shadow-2xl transition transform hover:scale-105"
            >
              Get Started Free
              <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" />
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Hero Section */}
        <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl shadow-xl p-8 lg:p-12 mb-8 text-white relative overflow-hidden">
          <div className="relative z-10">
            ...
            <button
              ...
              className="inline-flex items-center px-6 py-3 bg-white text-indigo-600 font-semibold rounded-xl hover:shadow-xl transition transform hover:scale-105"
            >
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
          ...
          {loading ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-gray-500 mb-6">Start your first interview practice session now!</p>
              <button
                onClick={() => navigate('/chat-config')}
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-indigo-600 to-purple-600 text-white font-semibold rounded-xl hover:shadow-lg transition"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                </svg>
...
const FeatureCard = ({ icon, title, description, step }) => (
  <div className="relative bg-white p-8 rounded-2xl shadow-sm border border-gray-200 hover:shadow-lg transition">
    <div className="absolute -top-4 -left-4 w-12 h-12 bg-gradient-to-br from-indigo-600 to-purple-600 rounded-xl flex items-center justify-center text-white font-bold shadow-lg">
      {step}
    </div>
...
const SessionCard = ({ session, onView, onDelete }) => {
  ...
  return (
    <div 
      className="border border-gray-200 rounded-xl p-6 hover:shadow-md hover:border-indigo-300 transition cursor-pointer group"
      onClick={onView}
    >
        ...
        <div className="flex-1">
          ...
          {session.isCompleted && session.finalScore && (
            <div className="flex items-center gap-4">
              <div className={`px-4 py-2 rounded-lg font-bold ${getScoreColor(session.finalScore)}`}>
